...
const About = () => {
    return (
        <div className="px-4 md:px-18 mb-6 md:mb-10 mt-8 md:mt-15"> 
            ...
            <section className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-stretch gap-8 md:gap-6">
                {/* Left column - Image */}
                <div className="flex flex-col items-center md:items-start w-full md:w-auto">
                    <div className="w-64 md:w-80 overflow-hidden bg-black h-full">
                    <img
                        src="/portrait.jpg"
            ...
            <div className="w-full max-w-5xl mx-auto mt-10 md:mt-8">
